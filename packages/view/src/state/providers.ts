import { type ConnectionStatus, DEFAULT_PROVIDER, findProvider, type ProviderInfo } from '@totvibe/protocol';
...
export const providerAtom = atom<ProviderInfo>(get => findProvider(get(providerNameAtom)) ?? DEFAULT_PROVIDER);
